...
Functional conformance testing is organised around **Systems Under Test (SUTs)**.
A SUT defines a logical system boundary for which functional requirements can be assessed in a controlled and repeatable way.
