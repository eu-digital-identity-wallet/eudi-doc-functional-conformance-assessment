...
## Objective
This test case verifies that the DataElementValue of data element resident_city is a well-formed CBOR text string.
...
D. The presence of data element resident_city in the device retrieval mdoc response was verified.
