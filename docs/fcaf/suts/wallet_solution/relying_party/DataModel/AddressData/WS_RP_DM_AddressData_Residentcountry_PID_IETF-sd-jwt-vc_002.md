# EuPid_DM_ResidentCountry_02

## Objective
This test case verifies that the claim resident_country is a String enconded in UTF-8.
...
D. The presence of claim resident_country in the IETF SD-JWT VC Credential presented was verified.

## Test Scenario
1. Verify that the claim resident_country is a String encoded in UTF-8, supporting the full unicode range.

## Expected results
1. The claim resident_country is a String encoded in UTF-8, supporting the full unicode range.