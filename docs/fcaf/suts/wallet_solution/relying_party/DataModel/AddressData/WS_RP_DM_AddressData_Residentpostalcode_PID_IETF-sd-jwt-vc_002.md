# EuPid_DM_ResidentPostalCode_02

## Objective
This test case verifies that the claim resident_postal_code is a String enconded in UTF-8.
...
D. The presence of claim resident_postal_code in the IETF SD-JWT VC Credential presented was verified.

## Test Scenario
1. Verify that the claim resident_postal_code is a String encoded in UTF-8, supporting the full unicode range.
