# EuPid_DM_ResidentCity_01

## Objective
This test case verifies that the claim resident_city is present in the Credential in IETF SD-JWT VC format if this is indicated in the ICS.
...
## Test Scenario
1. Verify the presence of a claim with identifier resident_city in the  Credential presented to the Verifier in IETF SD-JWT VC format.

## Expected results
1. One claim with identifier resident_city is present.