# EuPid_DM_EmailAddress_02

## Objective
This test case verifies that the claim email_address_is a String enconded in UTF-8.
...
## Test Scenario
1. Verify that the claim email_address is a String encoded in UTF-8, supporting the full unicode range.

## Expected results
1. The claim email_address is a String encoded in UTF-8, supporting the full unicode range