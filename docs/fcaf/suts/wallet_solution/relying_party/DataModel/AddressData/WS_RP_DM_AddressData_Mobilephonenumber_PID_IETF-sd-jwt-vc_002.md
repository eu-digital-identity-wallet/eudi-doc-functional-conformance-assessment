# EuPid_DM_MobilePhoneNumber_02

## Objective
This test case verifies that the claim mobile_phone_number is a String enconded in UTF-8.
...
## Test Scenario
1. Verify that the claim mobile_phone_number is a String encoded in UTF-8, supporting the full unicode range.

## Expected results
1. The claim mobile_phone_number is a String encoded in UTF-8, supporting the full unicode range.