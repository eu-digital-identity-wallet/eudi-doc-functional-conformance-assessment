...
## Objective
This test case verifies that the DataElementValue of data element resident_postal_code is a well-formed CBOR text string.
...
D. The presence of data element resident_postal_code in the device retrieval mdoc response was verified.
