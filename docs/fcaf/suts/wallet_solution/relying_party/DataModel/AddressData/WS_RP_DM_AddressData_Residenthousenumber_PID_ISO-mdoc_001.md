...
## Objective
This test case verifies that the data element resident_house_number is present in the mdoc data if this is indicated in the ICS.
...
## Test Scenario
1. Verify the presence of a data element with identifier resident_house_number in the device retrieval mdoc response. 2. Verify the presence of an ErrorItem for data element resident_house_number.

## Expected results
1. One data element with identifier resident_house_number is present. 2. There is no ErrorItem for data element resident_house_number.