...
## Objective
This test case verifies that the DataElementValue of data element resident_state is a well-formed CBOR text string.
...
D. The presence of data element resident_state in the device retrieval mdoc response was verified.
