# EuPid_DM_ResidentState_02

## Objective
This test case verifies that the claim resident_state is a String enconded in UTF-8.
...
The EUDI wallet contains a Credential in IETF SD-JWT VC format. `vct` claim includes base type of person identification "urn:eudi:pid:1". claim resident_state is included in a person identification data.
...
D. The presence of claim resident_state in the IETF SD-JWT VC Credential presented was verified.

## Test Scenario
1. Verify that the claim resident_state is a String encoded in UTF-8, supporting the full unicode range.

## Expected results
1. The claim resident_state is a String encoded in UTF-8, supporting the full unicode range.