...
## Objective
This test case verifies that the claim issuance_date is a String enconded in UTF-8.
...
## Test Scenario
1. Verify that the claim issuance_date is a String encoded in UTF-8, supporting the full unicode range

## Expected results
1. The claim issuance_date is a String encoded in UTF-8, supporting the full unicode range.