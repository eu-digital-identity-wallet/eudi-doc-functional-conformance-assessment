# EuPid_DM_DocumentNumber_01

## Objective
This test case verifies that the data element document_number is present in the mdoc data if this is indicated in the ICS.
...
## Test Scenario
1. Verify the presence of a data element with identifier document_number in the device retrieval mdoc response. 2. Verify the presence of an ErrorItem for data element document_number.

## Expected results
1. One data element with identifier document_number is present. 2. There is no ErrorItem for data element document_number.