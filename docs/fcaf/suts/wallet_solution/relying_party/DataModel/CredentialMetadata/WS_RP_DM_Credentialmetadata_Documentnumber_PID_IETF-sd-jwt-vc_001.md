...
## Objective
This test case verifies that the claim document_number is present in the Credential in IETF SD-JWT VC format if this is indicated in the ICS.
...
The EUDI wallet contains a Credential in IETF SD-JWT VC format. `vct` claim includes base type of person identification "urn:eudi:pid:1". claim document_number is included in a person identification data.
