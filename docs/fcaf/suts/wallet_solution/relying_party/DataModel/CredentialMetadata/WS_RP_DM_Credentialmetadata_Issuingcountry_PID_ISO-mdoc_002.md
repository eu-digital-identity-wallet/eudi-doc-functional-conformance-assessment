# EuPid_DM_IssuingCountry_02

## Objective
This test case verifies that the DataElementValue of data element issuing_country is a well-formed CBOR text string.
...
D. The presence of data element issuing_country in the device retrieval mdoc response was verified.
