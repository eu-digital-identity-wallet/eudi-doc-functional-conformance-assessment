...
## Objective
This test case verifies that the DataElementValue of data element issuing_authority is a well-formed CBOR text string.
...
D. The presence of data element issuing_authority in the device retrieval mdoc response was verified.
