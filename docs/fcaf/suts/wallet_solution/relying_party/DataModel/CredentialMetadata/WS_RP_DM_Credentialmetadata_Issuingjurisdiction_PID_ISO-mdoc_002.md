# EuPid_DM_IssuingJurisdiction_02

## Objective
This test case verifies that the DataElementValue of data element issuing_jurisdiction is a well-formed CBOR text string.
