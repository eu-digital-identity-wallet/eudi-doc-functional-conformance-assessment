# EuPid_DM_PersonalAdministrativeNumber_02

## Objective
This test case verifies that the claim personal_administrative_number is a String enconded in UTF-8.
...
The EUDI wallet contains a Credential in IETF SD-JWT VC format. `vct` claim includes base type of person identification "urn:eudi:pid:1". claim personal_administrative_number is included in a person identification data.
...
D. The presence of claim personal_administrative_number in the IETF SD-JWT VC Credential presented was verified.
