...
## Objective
This test case verifies that the DataElementValue of data element personal_administrative_number is a well-formed CBOR text string.
...
D. The presence of data element personal_administrative_number in the device retrieval mdoc response was verified.
