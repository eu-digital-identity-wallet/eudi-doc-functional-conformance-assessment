# EuPid_DM_BirthDate_01

## Objective
This test case verifies that the data element birth_date is present in the mdoc data.
...
## Test Scenario
1. Verify the presence of a data element with identifier birth_date in the device retrieval mdoc response. 2. Verify the presence of an ErrorItem for data element birth_date.

## Expected results
1. One data element with identifier birth_date is present. 2. There is no ErrorItem for data element birth_date.