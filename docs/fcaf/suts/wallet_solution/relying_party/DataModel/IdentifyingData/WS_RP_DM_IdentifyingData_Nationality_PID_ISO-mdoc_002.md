...
## Objective
This test case verifies that the DataElementValue of data element nationality is an an array of Alpha-2 country codes as specified in ISO 3166-1.
...
## Test Scenario
1. Verify the major type encoded on the first byte of the CBOR data item. 2. Verify the number of items in the array.

## Expected results
1. The major type value is equal to 4. 2. There are >= 1 items in the array.