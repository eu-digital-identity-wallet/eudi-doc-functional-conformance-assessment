# EuPid_DM_Nationality_01

## Objective
This test case verifies that the data element nationality is present in the mdoc data.
...
## Test Scenario
1. Verify the presence of a data element with identifier nationality in the device retrieval mdoc response. 2. Verify the presence of an ErrorItem for data element nationality.

## Expected results
1. One data element with identifier nationality is present. 2. There is no ErrorItem for data element nationality.