...
## Objective
This test case verifies that the DataElementValue of data element given_name is a well-formed CBOR text string.
...
D. The presence of data element given_name in the device retrieval mdoc response was verified.
