...
## Test Scenario
For each item present, perform the following check: 1 Verify the value of the key for each nested key/value pair. 2. Verify that each key is unique within the DrivingPrivilege data item.
