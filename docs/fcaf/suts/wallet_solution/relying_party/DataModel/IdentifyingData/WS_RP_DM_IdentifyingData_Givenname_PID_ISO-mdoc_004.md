...
## Objective
This test case verifies that the DataElementValue of data element given_name_birth is a well-formed CBOR text string.
...
D. The presence of data element given_name_birth in the device retrieval mdoc response was verified.
