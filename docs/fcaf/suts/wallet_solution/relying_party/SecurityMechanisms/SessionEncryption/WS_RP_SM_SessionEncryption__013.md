...
E. The presentation value of the credential contains a correctly serialized SD-JWT.
F. The presentation value of the credential contains correctly serialized disclosures.
G. The SD-JWT contains a `_sd_alg` valid and acceptable.
