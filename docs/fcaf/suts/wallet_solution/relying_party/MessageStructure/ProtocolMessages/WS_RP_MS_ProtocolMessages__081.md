...
2. The Verifier sends a Authorization Request with a DCQL-query with a credential with the "require_cryptographic_holder_binding" property in NON-boolean form.
