# WS_RP_MS_CredentialFormats_033a

## Objective

Verify that the Wallet includes the `status` element in a mdoc presentation, when the issuer included the status information in the credential.
...
1. Verify the MSO of the presented mdoc credential.

## Expected results

1. The MSO of the presented mdoc contains a `status` key in the MSO.
