...
F. Wallet send a correctly signed and trusted Wallet Instance Attestation as a Client Attestation.
G. Wallet send a syntactically correct header of the Wallet Instance Attestation as Client Attestation.
