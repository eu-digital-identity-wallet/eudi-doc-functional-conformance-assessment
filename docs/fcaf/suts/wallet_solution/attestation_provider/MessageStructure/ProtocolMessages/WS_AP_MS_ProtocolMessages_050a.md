...
D. The Wallet obtained an Access Token from a Token Response that did not return `credential_identifiers`.
E. Wallet send a correctly formatted HTTP Request to the Credential Endpoint.
