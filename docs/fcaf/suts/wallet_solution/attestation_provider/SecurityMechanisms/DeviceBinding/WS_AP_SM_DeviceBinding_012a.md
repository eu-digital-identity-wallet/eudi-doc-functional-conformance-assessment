...
G. Wallet send a valid and trusted signed JWT as proof of Key Attestation, with the Credential Request.
H. Wallet send a syntactically correct `nonce` in the proof of Key Attestation.
