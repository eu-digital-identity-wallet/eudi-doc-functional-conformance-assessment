...
G. Wallet send a JWT as value of the `jwt` property in the `proofs` parameter of the Credential Request.
H. The proof with Key Attestation uses an acceptable signature algorithm.
